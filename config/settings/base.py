...
MIGRATION_MODULES = {
    'sites': 'bokaforlag.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Kristján Norland""", 'kristjannorland@gmail.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'bokaforlag.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'bokaforlag.users.adapters.SocialAccountAdapter'
...
DEFAULT_FROM_EMAIL = 'amforlag@gmail.com'
SERVER_EMAIL = 'amforlag@gmail.com'
